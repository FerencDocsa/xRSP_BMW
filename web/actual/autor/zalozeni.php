        ...
        <div class="table-test table-zalozeni">
            ...
            <form class="form-signin" method="POST" action="" enctype="multipart/form-data">
                <div class="inp">
                    ...
                    <label>Popís</label>
                    <textarea class="form-group form-control" style="margin-top: -2.5%;" name="popis" rows="2" required></textarea>
                    ...
                    <strong>2/2019: </strong>
                    <?php echo $vysl_k[0]; ?> volnych mist <strong>3/2019: </strong>
                    <?php echo $vysl_k1[0]; ?> volnych mist
                    <br>
                    <label>Soubor</label>
