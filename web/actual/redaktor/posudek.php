...
$query = "SELECT formular.hodnoceni, formular.posudek, formular.zaver, posudek.id_oponent FROM formular INNER JOIN posudek ON posudek.posudek = formular.id_formular WHERE posudek.id_prispevek = '".$_GET['id']."' ";
...
$r2 = mysqli_fetch_assoc($sql2);
 ...
 {
   $zpristupnit = "UPDATE posudek SET pristup = 1 WHERE id_prispevek = '".$_GET['id']."'";
   ...
   header("Location: http://plogos.epizy.com/redaktor/");
   die();
 }
    ...
    <div class="container">
        ...
        <div class="table-test table-view">
            ...
            <form enctype="multipart/form-data" action="" method="post">
                ...
                <br>
                <input type="text" value=" <?php echo $r['zaver'];?>" readonly="true" />
                <br>
                <br>
                <button type="submit" class="btn btn-success">Zpřístupnit Autorovi</button>
            </form>
        </div>
