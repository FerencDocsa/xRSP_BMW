...
require("session.php");
//query role
$autor_query = "SELECT userid, username FROM users WHERE role = 6";
$autor_result = mysqli_query($connection, $autor_query);

//fetch prispevky
if(isset($_POST['select_autor']))
{
$sql = "SELECT id, nazev, cislo, stav.popis, posudek.datum FROM posudek INNER JOIN prispevky ON posudek.id_prispevek = prispevky.id  INNER JOIN stav ON prispevky.stav = stav.id_stav WHERE stav = 2 AND id_oponent = '". $_POST['select_autor'] ."' ";
$result = mysqli_query($connection, $sql);


$sql_pridelene = "SELECT id, nazev, cislo, stav.popis, posudek.datum FROM posudek INNER JOIN prispevky ON posudek.id_prispevek = prispevky.id  INNER JOIN stav ON prispevky.stav = stav.id_stav WHERE stav = 7 AND id_oponent = '". $_POST['select_autor'] ."'";
...
<body>
  ...
  <div class="select-border">
        ...
        <form method="post" action="" enctype="multipart/form-data">
            ...
            <button id="pridelit" class="btn btn-success">Vybrat</a>
        </form>
    </div>
   ...
   ?>
                    <tr>
                        ...
                        <td><a href="view.php?id=<?php echo $q['id']?>">
