...
<?php
require("session.php");
$sql = "SELECT id, nazev, stav FROM prispevky INNER JOIN stav ON prispevky.stav = stav.id_stav WHERE autor = '".$_GET["autor"]."' ";
$sql2 = "SELECT userid, username FROM users WHERE role = 1";
...
<body>
  ...
  <div class="header">
    <h1 align="center">Sefredaktor</h1>
    <h4 align="center">Agenda autora</h4>
  </div>
...
<div class = "tablx3">
<h3 class="text-center">Vybrany přispevek</h3>
</div>
